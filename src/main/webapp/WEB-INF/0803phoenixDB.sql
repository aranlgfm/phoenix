...
INSERT INTO `COM_ARTICLE_TB` (`ARTICLE_CD`, `USER_CD`, `BOARDGROUP_CD`, `ARTICLE_NM`, `ARTICLE_CTT`, `ARTICLE_DT`, `ARTICLE_IP`) VALUES
	...
	('COM_ARTICLE_8', 'COM_USER_4', 'COM_BOARDGROUP_3', 'sdfhsfgh', 'dfghdfghdgfhdfg', '2016-08-02 14:48:51', '안되는건가?'),
	('COM_ARTICLE_7', 'COM_USER_4', 'COM_BOARDGROUP_3', 'ealskdgjalksdj', 'sdflkgja;lkdfjg;laksd', '2016-08-02 14:47:56', '안되는건가?'),
	('COM_ARTICLE_6', 'COM_USER_4', 'COM_BOARDGROUP_3', 'adshfkasd;lfaj;', 'asdlkajsdkjadsg', '2016-08-02 14:47:42', '안되는건가?'),
...
INSERT INTO `COM_USER_TB` (`USER_CD`, `USER_GROUP_NM`, `USER_NM`, `USER_NICK_NM`, `USER_ID`, `USER_PW`, `USER_SEX_FL`, `USER_ANNIVERSARY_DT`, `USER_BIRTH_DT`, `USER_ADDR`, `USER_POST_NO`, `USER_EMAIL_ADDR`, `USER_JOIN_DT`, `USER_SHOP_CD`, `USER_PHONE_NO`, `USER_CELLPHONE_NO`, `USER_INTRODUCE_CTT`) VALUES
	...
	('COM_USER_4', '회원', '김테슽', '완료', '111', '111', 1, '2016-07-28', '2016-07-28', '1동', 00000000555, 'aranlgfm@gmail.com', '2016-07-26 17:07:51', 'CRM_SHOP_1', '111222333', '111222333', '(NULL)'),
	...
	('COM_USER_22', '회원', '테스트입니다', '테스트에요', 'test77', 'test77', 0, NULL, NULL, '', 00000000222, 'aranlgfm@gmail.com', '2016-07-27 11:32:04', 'CRM_SHOP_1', NULL, NULL, NULL),
...
# Dumping data for table phoenixooo.CRM_ACCOUNT_TB: 3 rows
/*!40000 ALTER TABLE `CRM_ACCOUNT_TB` DISABLE KEYS */;
INSERT INTO `CRM_ACCOUNT_TB` (`ACCOUNT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `ACCOUNT_NM`, `CHARGER_NM`, `CHARGER_CELLPHONE_NO`, `CHARGER_PHONE_NO`, `CHARGER_FAX_NO`, `CHARGER_MEMO`) VALUES
	('CRM_ACCOUNT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', '삼성', '이건희', '01054855548', '02147483647', '0648485656', ''),
	('CRM_ACCOUNT_2', 'CRM_SHOP_3', 'CRM_EMPLOYEE_1', 'lg', '김또깡', '01054855348', '02147483647', '0648484656', ''),
	('CRM_ACCOUNT_3', 'CRM_SHOP_1', 'CRM_EMPLOYEE_2', 'SK', '김냥냥', '01034855348', '02147483647', '0648434656', '');
...
# Dumping data for table phoenixooo.CRM_CUSTOMER_TB: 4 rows
/*!40000 ALTER TABLE `CRM_CUSTOMER_TB` DISABLE KEYS */;
INSERT INTO `CRM_CUSTOMER_TB` (`CUSTOMER_CD`, `USER_CD`, `CUSTOMER_NM`, `CUSTOMER_CELLPHONE_NO`, `CUSTOMER_SEX_FL`, `CUSTOMER_FIRST_VISIT_DT`, `CUSTOMER_JOIN_DT`, `EMPLOYEE_CD`, `EMPLOYEE_NM`, `CUSTOMER_BIRTH_DT`, `CUSTOMER_POST_NO`, `CUSTOMER_ADDR`, `CUSTOMER_EMAIL_ADDR`, `CUSTOMER_ANNIVERSARY_DT`, `CUSTOMER_MEMO`) VALUES
	('CRM_CUSTOMER_1', '미용실회원', '김수현', '0101111111', 0, '2016-08-01', '2016-08-01 11:47:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('CRM_CUSTOMER_2', 'COM_USER_25', '전지현', '01000001111', 1, '2016-08-01', '2016-08-01 12:27:10', '1', '루시우', '2016-08-02', 0, '1', '1', '2016-08-01', NULL),
	('CRM_CUSTOMER_4', '미용실회원', '배수지', '222333222', 1, NULL, '2016-08-01 13:54:59', NULL, '메르시', NULL, NULL, '', 'suzi@mail', NULL, ''),
	('CRM_CUSTOMER_3', 'COM_USER_12', '유아인', '123123123', 0, NULL, '2016-08-01 13:54:39', NULL, '', NULL, NULL, '', 'test', NULL, '');
...
# Dumping data for table phoenixooo.CRM_EMPLOYEE_TB: 5 rows
...
INSERT INTO `CRM_EMPLOYEE_TB` (`EMPLOYEE_CD`, `SHOP_CD`, `EMPLOYEE_PW`, `EMPLOYEE_NM`, `EMPLOYEE_BIRTH_DT`, `EMPLOYEE_ADDR`, `EMPLOYEE_PHONE_NO`, `EMPLOYEE_CELLPHONE_NO`, `EMPLOYEE_JOIN_DT`, `EMPLOYEE_MEMO`, `EMPLOYEE_LEVEL_NM`) VALUES
	...
	('CRM_EMPLOYEE_2', 'CRM_SHOP_1', '2222', '앤디', '2016-07-22', '대전', '02147483647', '01059687451', '2016-07-22', '', '사원'),
...
CREATE TABLE IF NOT EXISTS `CRM_ETC_COSTTYPE_TB` (
  ...
  `ETC_COST_TYPE_NM` varchar(50) NOT NULL,
  `ETC_COST_ST` varchar(50) NOT NULL,
  PRIMARY KEY (`ETC_COSTTYPE_CD`),
  UNIQUE KEY `ETC_COST_CD` (`ETC_COST_CD`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='기타지출세부항목';

# Dumping data for table phoenixooo.CRM_ETC_COSTTYPE_TB: 2 rows
/*!40000 ALTER TABLE `CRM_ETC_COSTTYPE_TB` DISABLE KEYS */;
INSERT INTO `CRM_ETC_COSTTYPE_TB` (`ETC_COSTTYPE_CD`, `SHOP_CD`, `ETC_COST_CD`, `ETC_COST_NM`, `ETC_COST_TYPE_NM`, `ETC_COST_ST`) VALUES
	('CRM_ETC_COSTTYPE_1', 'CRM_SHOP_1', 'CRM_ETC_COST_1', '세금', '수도', ''),
	('CRM_ETC_COSTTYPE_2', 'CRM_SHOP_1', 'CRM_ETC_COST_2', '세금', '전기', '');
...
# Dumping data for table phoenixooo.CRM_ETC_COST_TB: 3 rows
...
# Dumping data for table phoenixooo.CRM_GOODS_PAYMENT_TB: 3 rows
/*!40000 ALTER TABLE `CRM_GOODS_PAYMENT_TB` DISABLE KEYS */;
INSERT INTO `CRM_GOODS_PAYMENT_TB` (`PAYMENT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `ACCOUNT_CD`, `GOODS_CD`, `PAYMENT_DT`, `CHARGER_NM`, `GOODS_NM`, `BUYING_GOODS_UNIT_WON`, `ORDER_QUANTITY_NO`, `PAYMENT_MEMO`) VALUES
	('CRM_GOODS_PAYMENT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'CRM_ACCOUNT_1', 'CRM_GOODS_1', '2016-07-22 14:08:43', '이승주', '샤랄라샴푸', 30000, 30, '이상무'),
	('CRM_GOODS_PAYMENT_2', 'CRM_SHOP_2', 'CRM_EMPLOYEE_2', 'CRM_ACCOUNT_2', 'CRM_GOODS_2', '2016-07-22 14:11:51', '이승주', '샤랄라샴푸', 30000, 30, '이상무'),
	('CRM_GOODS_PAYMENT_3', 'CRM_SHOP_3', 'CRM_EMPLOYEE_3', 'CRM_ACCOUNT_3', 'CRM_GOODS_3', '2016-07-22 14:12:34', '이승주', '샤랄라샴푸', 30000, 30, '이상무');
...
CREATE TABLE IF NOT EXISTS `CRM_GOODS_STOCK_TB` (
  ...
  `ACCOUNT_CD` varchar(45) NOT NULL,
  `PAYMENT_CD` varchar(45) DEFAULT NULL,
  `SHOP_CD` varchar(45) NOT NULL,
  `EMPLOYEE_CD` varchar(45) NOT NULL,
  `GOODS_CD` varchar(45) NOT NULL,
...
# Dumping data for table phoenixooo.CRM_GOODS_STOCK_TB: 2 rows
/*!40000 ALTER TABLE `CRM_GOODS_STOCK_TB` DISABLE KEYS */;
INSERT INTO `CRM_GOODS_STOCK_TB` (`STOCK_CD`, `ACCOUNT_CD`, `PAYMENT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `GOODS_CD`, `STOCK_DT`, `GOODS_QUANTITY_NO`) VALUES
	('CRM_GOODS_STOCK_1', 'CRM_ACCOUNT_1', 'CRM_GOODS_PAYMENT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'CRM_GOODS_1', '2016-07-22 14:03:12', 30),
	('CRM_GOODS_STOCK_2', 'CRM_ACCOUNT_2', 'CRM_GOODS_PAYMENT_2', 'CRM_SHOP_2', 'CRM_EMPLOYEE_2', 'CRM_GOODS_2', '2016-07-22 14:03:32', 30);
...
# Dumping data for table phoenixooo.CRM_GOODS_TB: 3 rows
...
INSERT INTO `CRM_GOODS_TB` (`GOODS_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `ACCOUNT_CD`, `GOODS_NM`, `BUYING_GOODS_UNIT_WON`, `SALE_GOODS_UNIT_WON`, `GOODS_MEMO`) VALUES
	...
	('CRM_GOODS_2', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'CRM_ACCOUNT_1', '댕기머리린스', 11000, 40000, ''),
...
# Dumping data for table phoenixooo.CRM_GOODS_USE_TB: 3 rows
...
INSERT INTO `CRM_ITEM_DESIGN_TB` (`ITEMDESIGN_CD`, `SHOP_CD`, `ITEM_CD`, `ITEMDESIGN_NM`, `ITEMDESIGN_WON`, `ITEMDESIGN_REGISTE_DT`) VALUES
	('CRM_ITEM_DESIGN_1', 'CRM_SHOP_1', 'CRM_ITEM_1', '아놀드파마', 20000, '1111-00-00 00:00:00'),
	('CRM_ITEM_DESIGN_3', 'CRM_SHOP_3', 'CRM_ITEM_3', '어른컷', 14000, '2011-00-00 00:00:00'),
	('CRM_ITEM_DESIGN_9', 'CRM_SHOP_1', 'CRM_ITEM_1', '2212', 2212, '2016-08-02 17:29:31'),
	('CRM_ITEM_DESIGN_8', 'CRM_SHOP_1', 'CRM_ITEM_2', '샤기컷', 200000, '2016-08-02 13:17:39'),
	('CRM_ITEM_DESIGN_7', 'CRM_SHOP_1', 'CRM_ITEM_2', '남자컷', 200000, '2016-08-02 13:17:33'),
	('CRM_ITEM_DESIGN_6', 'CRM_SHOP_1', 'CRM_ITEM_1', '개놀드파마', 222, '2016-08-02 13:16:38'),
	('CRM_ITEM_DESIGN_5', 'CRM_SHOP_1', 'CRM_ITEM_1', '테스트파마', 1, '2016-08-02 13:16:32'),
	('CRM_ITEM_DESIGN_4', 'CRM_SHOP_1', 'CRM_ITEM_2', '여자컷', 111, '2016-08-02 13:13:36');
...
INSERT INTO `CRM_ITEM_TB` (`ITEM_CD`, `SHOP_CD`, `ITEM_NM`, `ITEM_REGISTE_DT`) VALUES
	...
	('CRM_ITEM_4', 'CRM_SHOP_1', '테스트', '2016-08-02 13:36:03');
...
# Dumping data for table phoenixooo.CRM_PAYMENT_TB: 3 rows
/*!40000 ALTER TABLE `CRM_PAYMENT_TB` DISABLE KEYS */;
INSERT INTO `CRM_PAYMENT_TB` (`PAYMENT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `USER_CD`, `POINT_CD`, `ITEMDESIGN_CD`, `USER_NM`, `EMPLOYEE_NM`, `ITEMDESIGN_NM`, `PAYMENT_TYPE_GB`, `PAYMENT_TOTAL_WON`, `PAYMENT_DT`) VALUES
	('CRM_PAYMENTENT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'COM_USER_10', 'CRM_POINT_1', 'CRM_ITEM_DESIGN_1', '신복기', '강재욱', '아놀드파마', '현금', 50000, '2016-07-22 12:08:18'),
	('CRM_PAYMENTENT_2', 'CRM_SHOP_2', 'CRM_EMPLOYEE_3', 'COM_USER_11', 'CRM_POINT_1', 'CRM_ITEM_DESIGN_1', '이승주', '강재욱', '아놀드파마', '현금', 30000, '2016-07-22 12:11:53'),
	('CRM_PAYMENTENT_3', 'CRM_SHOP_2', 'CRM_EMPLOYEE_3', 'COM_USER_12', 'CRM_POINT_2', 'CRM_ITEM_DESIGN_2', '신복기', '구아란', '파뿌리염색', '현금', 300000, '2016-07-22 12:12:29');
