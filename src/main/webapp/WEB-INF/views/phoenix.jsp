...
<div>
	...
	로그인성공시 :
		<select onchange="window.open(value, '_self');">
			...
			<option value="/phoenix/com/form/paymentList?userCode=${userCustomer.userCode}">주문결제내역</option>
			<option value="/phoenix/com/form/repaymentList?userCode=${userCustomer.userCode}">환불내역</option>
		</select>
	</form>	
</div>
