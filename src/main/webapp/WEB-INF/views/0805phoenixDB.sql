...
INSERT INTO `COM_USER_TB` (`USER_CD`, `USER_GROUP_NM`, `USER_NM`, `USER_NICK_NM`, `USER_ID`, `USER_PW`, `USER_SEX_FL`, `USER_ANNIVERSARY_DT`, `USER_BIRTH_DT`, `USER_ADDR`, `USER_POST_NO`, `USER_EMAIL_ADDR`, `USER_JOIN_DT`, `USER_SHOP_CD`, `USER_PHONE_NO`, `USER_CELLPHONE_NO`, `USER_INTRODUCE_CTT`) VALUES
	...
	('COM_USER_4', '회원', '차이수', '완료', '111', '111', 1, '2016-07-28', '2016-07-28', '1동', 00000000555, 'aranlgfm@gmail.com', '2016-07-26 17:07:51', 'CRM_SHOP_1', '111222333', '111222333', '(NULL)'),
...
# Dumping data for table phoenixooo.CRM_ACCOUNT_TB: 4 rows
...
INSERT INTO `CRM_CUSTOMER_TB` (`CUSTOMER_CD`, `USER_CD`, `CUSTOMER_NM`, `CUSTOMER_CELLPHONE_NO`, `CUSTOMER_SEX_FL`, `CUSTOMER_FIRST_VISIT_DT`, `CUSTOMER_JOIN_DT`, `EMPLOYEE_CD`, `EMPLOYEE_NM`, `CUSTOMER_BIRTH_DT`, `CUSTOMER_POST_NO`, `CUSTOMER_ADDR`, `CUSTOMER_EMAIL_ADDR`, `CUSTOMER_ANNIVERSARY_DT`, `CUSTOMER_MEMO`) VALUES
	('CRM_CUSTOMER_1', '미용실회원', '김수현', '0101111111', 0, '2016-08-01', '2016-08-01 11:47:10', '2', '차홍', NULL, NULL, NULL, NULL, NULL, '잘생겼다'),
	('CRM_CUSTOMER_2', 'COM_USER_25', '전지현', '01000001111', 1, '2016-08-01', '2016-08-01 12:27:10', '1', '루시우', '2016-08-02', 0, '1', '1', '2016-08-01', '좀 이상하게 생겼어요'),
	('CRM_CUSTOMER_5', '미용실회원', '차이수', '010', 0, NULL, '2016-08-04 17:22:32', NULL, '차홍', NULL, NULL, '', '1111', NULL, '엄청 잘생겼네..'),
	('CRM_CUSTOMER_4', '미용실회원', '배수지', '222333222', 1, '2016-08-04', '2016-08-01 13:54:59', '3', '메르시', NULL, NULL, '', 'suzi@mail', NULL, '차이수님이랑 잘 어울리시는듯'),
	('CRM_CUSTOMER_3', 'COM_USER_12', '유아인', '123123123', 0, '2016-08-04', '2016-08-01 13:54:39', '4', '비달사순', NULL, NULL, '', 'test', NULL, '돈 많으신듯한 손님.');
...
# Dumping data for table phoenixooo.CRM_GOODS_STOCK_TB: 5 rows
...
INSERT INTO `CRM_GOODS_STOCK_TB` (`STOCK_CD`, `ACCOUNT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `GOODS_CD`, `STOCK_DT`, `GOODS_QUANTITY_NO`) VALUES
	('CRM_GOODS_STOCK_1', 'CRM_ACCOUNT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'CRM_GOODS_1', '2016-07-22 14:03:12', 30),
	...
	('CRM_GOODS_STOCK_4', 'CRM_ACCOUNT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_2', 'CRM_GOODS_2', '2016-08-03 16:11:46', 3),
	('CRM_GOODS_STOCK_5', 'CRM_ACCOUNT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_2', 'CRM_GOODS_2', '2016-08-05 09:08:37', 3);
...
# Dumping data for table phoenixooo.CRM_ITEM_DESIGN_TB: 6 rows
...
INSERT INTO `CRM_ITEM_DESIGN_TB` (`ITEMDESIGN_CD`, `SHOP_CD`, `ITEM_CD`, `ITEMDESIGN_NM`, `ITEMDESIGN_WON`, `ITEMDESIGN_REGISTE_DT`) VALUES
	...
	('CRM_ITEM_DESIGN_10', 'CRM_SHOP_1', 'CRM_ITEM_5', '너나케어', 100000, '2016-08-03 14:44:42');
...
INSERT INTO `CRM_ITEM_TB` (`ITEM_CD`, `SHOP_CD`, `ITEM_NM`, `ITEM_REGISTE_DT`) VALUES
	...
	('CRM_ITEM_5', 'CRM_SHOP_1', '헤어케어', '2016-08-03 13:42:22');
...
# Dumping data for table phoenixooo.CRM_PAYMENT_TB: 4 rows
...
INSERT INTO `CRM_PAYMENT_TB` (`PAYMENT_CD`, `SHOP_CD`, `EMPLOYEE_CD`, `USER_CD`, `POINT_CD`, `ITEMDESIGN_CD`, `USER_NM`, `EMPLOYEE_NM`, `ITEMDESIGN_NM`, `PAYMENT_TYPE_GB`, `PAYMENT_TOTAL_WON`, `PAYMENT_DT`) VALUES
	('CRM_PAYMENT_1', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'COM_USER_1', 'CRM_POINT_1', 'CRM_ITEM_DESIGN_1', '구아란', '겐지', '아놀드파마', '현금', 50000, '2016-07-22'),
	('CRM_PAYMENT_2', 'CRM_SHOP_1', 'CRM_EMPLOYEE_3', 'COM_USER_2', 'CRM_POINT_1', 'CRM_ITEM_DESIGN_1', '이승주', '라인하르트', '아놀드파마', '카드', 30000, '2016-07-22'),
	('CRM_PAYMENT_3', 'CRM_SHOP_1', 'CRM_EMPLOYEE_3', 'COM_USER_3', 'CRM_POINT_2', 'CRM_ITEM_DESIGN_2', '신복기', '라인하르트', '파뿌리염색', '현금', 300000, '2016-08-03'),
	('CRM_PAYMENT_4', 'CRM_SHOP_1', 'CRM_EMPLOYEE_3', 'COM_USER_4', 'CRM_POINT_3', 'CRM_ITEM_DESIGN_2', '차이수', '라인하르트', '파뿌리염색', '현금', 300000, '2016-08-03'),
	('CRM_PAYMENT_5', 'CRM_SHOP_1', 'CRM_EMPLOYEE_1', 'COM_USER_4', NULL, 'CRM_ITEM_DESIGN_9', '차이수', '겐지', '드래드 펌', '카드', 200000, '2016-08-05'),
	('CRM_PAYMENT_6', 'CRM_SHOP_1', 'CRM_EMPLOYEE_4', 'COM_USER_23', NULL, 'CRM_ITEM_DESIGN_12', '강재욱', '파라', '셋팅펌', '카드', 250000, '2016-08-05'),
	('CRM_PAYMENT_7', 'CRM_SHOP_1', 'CRM_EMPLOYEE_5', 'COM_USER_24', NULL, 'CRM_ITEM_DESIGN_2', '이승주', '디바', '파뿌리염색', '현금', 300000, '2016-08-05'),
	('CRM_PAYMENT_8', 'CRM_SHOP_1', 'CRM_EMPLOYEE_6', 'COM_USER_24', NULL, 'CRM_ITEM_DESIGN_12', '이승주', '류승룡', '셋팅펌', '현금', 250000, '2016-08-05');
